...
function listaOrdenada(num) {
    let numAnt, proxNum, pos

    // inserindo número na lista vazia
    if(lista.empty) {
        lista.insertHead(num)
    }
    // se 1º número da lista for maior que o número a ser inserido
    else if(lista.peekHead() > num) {
        lista.insertHead(num)
    }
    // se 1º número da lista for menor que o número a ser inserido
    else if(lista.peekHead() < num) {
        pos += 1
...
let inserted = listaOrdenada(25)
console.log(lista.print())

inserted = listaOrdenada(14)
console.log(lista.print())

inserted = listaOrdenada(19)
console.log(lista.print())

inserted = listaOrdenada(3)
console.log(lista.print())
